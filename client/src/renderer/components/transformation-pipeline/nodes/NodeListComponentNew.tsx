...
import { NodeComponentNew } from './NodeComponentNew';
...
interface NodeListComponentProps {
  ...
  allowedInputTypes?: string[]; // New prop for variable input types
  allowedOutputTypes?: string[]; // New prop for variable output types
...
export const NodeListComponentNew: React.FC<NodeListComponentProps> = ({
  moduleId,
  modulePosition,
  zoom,
  panOffset,
  ...
  allowedInputTypes = ['string', 'number', 'boolean', 'datetime'],
  allowedOutputTypes = ['string', 'number', 'boolean', 'datetime'],
  onNodeClick,
  onRemoveInput,
  onRemoveOutput,
  onAddInput,
