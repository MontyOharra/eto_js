...
export function EtoRunRow({ data, onClick, onSkip, onReprocess, onDelete, onViewPdf, onToggleRead }: EtoRunRowProps) {
      ...
      <div className="px-6">
        ...
        <div className="flex items-center gap-1.5 justify-end self-center">
          ...
          <button
            onClick={(e) => {
              e.stopPropagation();
              if (showReprocessButton && onReprocess) {
                onReprocess(data.id);
              }
            }}
