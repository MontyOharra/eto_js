...
// ============================================================================
// Single Run Operations (Aggregates failed/needs_template sub-runs)
// ============================================================================
...
export function useReprocessRun() {
  ...
  return useMutation({
    ...
    onSuccess: (_, runId) => {
      // Invalidate runs list and the specific run detail
      queryClient.invalidateQueries({ queryKey: ['eto-runs'] });
      queryClient.invalidateQueries({ queryKey: ['eto-run', runId] });
    },
  });
}
