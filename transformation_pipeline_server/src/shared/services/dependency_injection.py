...
class DependencyInjectionContainer:
    ...
    def _param_to_service_name(self, param_name: str) -> str:
        ...
        # Transformation pipeline service mappings
        mappings = {
...
def configure_services(container: DependencyInjectionContainer,
                      connection_manager):
    """
    Configure all services for the Transformation Pipeline application
    ...
    # Register modules service
    container.register(
        name='modules',
        factory=lambda: ModulesService(),
        lifetime=ServiceLifetime.SINGLETON,
        dependencies=[]
    )
...
def initialize_container(connection_manager) -> DependencyInjectionContainer:
    """Initialize the global DI container with all services"""
    container = get_container()
    configure_services(container, connection_manager)
    return container