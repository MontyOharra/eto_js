"""
ETO Run Pipeline Execution Step Domain Types
Dataclasses representing eto_run_pipeline_execution_steps table and related operations
"""
...
@dataclass
class EtoRunPipelineExecutionStepUpdate:
    """
...
@dataclass
class EtoRunPipelineExecutionStep:
    """
    Complete pipeline execution step record as stored in the database.
    Represents the eto_run_pipeline_execution_steps table exactly.
    """
    id: int
    run_id: int  # FK to eto_run_pipeline_executions.id
    module_instance_id: str
