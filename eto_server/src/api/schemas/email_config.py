"""
Email Config Pydantic Models
Core models for email ingestion configuration management
"""
...
class EmailConfigCreate(EmailConfigBase):
    """Model for creating new email configurations"""
...
class EmailConfigUpdate(BaseModel):
    """Model for updating existing email configurations"""
    description: Optional[str] = Field(None, max_length=1000, description="Configuration description")
